...
//		});
	...
	public static void main(String args[]) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				final ARDroneTest ardrone_test = new ARDroneTest();
				ardrone_test.addKeyListener(new KeyAdapter() {
					
					private ARDrone ardrone = ardrone_test.ardrone;
				...
				ardrone_test.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				ardrone_test.addWindowListener(new WindowAdapter() {
					@Override
					...
					public void windowClosing(WindowEvent e) {
						ardrone_test.dispose();
					}
				});
				
				ardrone_test.setVisible(true);
			}
		});
	}
}